...
`)},Lp=r=>le({axis:r.attributes.getInt("axis")}),aI=r=>{if(!r||r.length<1)throw new Error("too few inputs");let e=r[0].type,n=r[0].dims.length;if(e==="string")throw new Error("string tensor is not supported yet");for(let t of r){if(t.type!==e)throw new Error("input tensors should be one type");if(t.dims.length!==n)throw new Error("input tensors should have the same shape")}}});function sI(){return yt("abs")}function uI(){return yt("acos")}function lI(){return yt("asin")}function cI(){return yt("atan")}function dI(){return yt("ceil")}function pI(){return yt("cos")}function fI(r){let e="elu";return{body:`
  ...
  `,name:r,type:0}}var SI,Re,Np,zp,Bp,Mp,uu,Vp,Fp,$I,Gp,Up,Wp,Hp,qp,jp,lu,Kp,Xp,Zp,Jp,Qp,Yp,ef,tf,nf,rf,of,cu=$(()=>{"use strict";We();xe();$n();Oe();pe();SI=(r,e,n,t)=>{let o=r.session.pack?2:0,i=j(r.session.backend.glContext.version);return{...e,output:{dims:n.dims,type:n.type,textureType:o},shaderSource:`
     ${t.body}
     void main() {
...
`)},T2=r=>{if(!r||r.length!==1)throw new Error("ImageScaler requires 1 input.");if(r[0].dims.length!==4)throw new Error("Invalid input shape.");if(r[0].type!=="float32"&&r[0].type!=="float64")throw new Error("Invalid input type.")}});var Vf,Ff,Mf,v2,I2,S2,$2,A2,P2,Gf=$(()=>{"use strict";Oe();pe();Vf=(r,e,n)=>{P2(e);let t=r.run(I2(e[0]),e);return[r.run(A2(r,e[0],n,t.dims),[e[0],t,e[1],e[2]])]},Ff=r=>r.attributes.getFloat("epsilon",1e-5),Mf={name:"InstanceNormalization_MeanAndVariance",inputNames:["X"],inputTypes:[0]},v2=(r,e)=>{let n=e.dims.slice(),t=n[1],o=n[2]*n[3],i=[n[0],t],a=`
      vec4 process(int[2] indices) {
        ...
        return v;
      }`;return{...r,output:{dims:i,type:e.type,textureType:4},shaderSource:a}},I2=r=>({...Mf,get:()=>v2(Mf,r)}),S2={name:"InstanceNormalization_ComputeOutput",inputNames:["X","MeanAndVariance","Scale","B"],inputTypes:[0,4,0,0]},$2=(r,e,n,t,o)=>{let i=j(r.session.backend.glContext.version),[a,s]=r.calculateTextureWidthAndHeight(o,4),[u,l]=[a/4,s],c=`
 ...
 ${c}`,c=c.replace("return",`${s} = `);let p=`
    ...
    `),n="packedUVfrom1D",e[n]=new z(`
      ...
      `),n="sampleTexture";let t=j(this.context.glContext.version);return e[n]=new z(`
        ...
        }`),e}getInputsSamplingSnippets(){let e={},n=this.context.outputTextureLayout;return this.context.programInfo.inputNames.forEach((t,o)=>{let i=this.context.inputTextureLayouts[o],a=Mo(t);i.isPacked?e[a]=this.getPackedSamplerFromInput(a,t,i):e[a]=this.getUnpackedSamplerFromInput(a,t,i);let s=Xd(t);i.unpackedShape.length<=n.unpackedShape.length&&(i.isPacked?e[s]=this.getPackedSamplerAtOutputCoords(s,i,n,t):e[s]=this.getUnpackedSamplerAtOutputCoords(s,i,n,t))}),e}getPackedSamplerAtOutputCoords(e,n,t,o){let i=n.unpackedShape,a=t.unpackedShape,u=Mo(o),l=i.length,c=a.length,d=Ze.getBroadcastDims(i,a),p=Je(c),f=c-l,h,m=St();l===0?h="":c<2&&d.length>=1?h="coords = 0;":h=d.map(O=>`coords.${m[O+f]} = 0;`).join(`
`);let y="";c<2&&l>0?y="coords":y=i.map((O,E)=>`coords.${m[E+f]}`).join(", ");let g="return outputValue;",x=V.size(i)===1,v=V.size(a)===1;if(l===1&&!x&&!v)g=`
    ...
    `;return new z(P,["coordinates.getOutputCoords"])}getUnpackedSamplerAtOutputCoords(e,n,t,o){let i=[t.width,t.height],a=[n.width,n.height],s=n.unpackedShape.length,u=t.unpackedShape.length,l=n.unpackedShape,c=t.unpackedShape,d=Mo(o);if(s===u&&Jn.arraysEqual(a,i)){let x=`
          float ${e}() {
...
`},W1=(r,e,n,t,o=!1)=>{let[i,a,s,u]=t,l=ve(t[0].type.tensor);return`
  ...
  ${m?al(y,g,U,F):sl(y,g,U,F)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
      ...
      }`,Ie=A("x",r[0].dataType,r[0].dims.length,v===3?1:v),Be=A("w",r[1].dataType,r[1].dims.length,Q),te=[Ie,Be],D=C("result",r[0].dataType,n.length,Q);if(a){let X=A("bias",r[2].dataType,r[2].dims.length,Q);te.push(X),ue+=`
    ...
    for (var i = 0u; i < ${a}u; i++) {
      ...
      ${m.set("batch","row","col + i","output_channel","value")};
        ...
        `,c===1)te+=`
          ...
          let xValue = ${K.getByOffset("x_offset")};
          let wValue = ${U.getByOffset("w_offset")};
          dotProd = dotProd + dot(xValue, wValue);`}return te},Be=`
  ...
  ${v.mainStart()}
    ...
    ${b?"inv_std_output[global_idx] = inv_std_dev":""};
          ...
          `;return Be},ue=()=>{let Be=`
            ...
            let zero_point = ${K}(8);`}
            `;for(let te=0;te<h*y;te++)Be+=`
            let scale${te} = ${M.getByOffset("col_index * nBlocksPerCol + block")};
            ${ae?`
            ...
            col_index += 1;`;return Be},Ie=()=>{let Be=`col_index = col * ${h};`;for(let te=0;te<h*y;te++)Be+=`
        ...
        ${q.mainStart([g,y,1])}
          ...
          for (var tile: u32 = 0; tile < num_tiles; tile += 1) {
            ...
            for (var i: u32 = 0; i < ${f}; i++) {
              ...
              let b_quantized_values = mat2x4<${ue}>(${Array.from({length:4},(Be,te)=>`${ue}(b_value_lower[${te}]), ${ue}(b_value_upper[${te}])`).join(", ")});
