...
`)},kp=r=>le({axis:r.attributes.getInt("axis")}),sI=r=>{if(!r||r.length<1)throw new Error("too few inputs");let e=r[0].type,n=r[0].dims.length;if(e==="string")throw new Error("string tensor is not supported yet");for(let t of r){if(t.type!==e)throw new Error("input tensors should be one type");if(t.dims.length!==n)throw new Error("input tensors should have the same shape")}}});function uI(){return yt("abs")}function lI(){return yt("acos")}function cI(){return yt("asin")}function dI(){return yt("atan")}function pI(){return yt("ceil")}function fI(){return yt("cos")}function hI(r){let e="elu";return{body:`
  ...
  `,name:r,type:0}}var $I,Re,Rp,Np,zp,Bp,uu,Mp,Vp,AI,Fp,Gp,Up,Wp,Hp,qp,lu,jp,Kp,Xp,Zp,Jp,Qp,Yp,ef,tf,nf,rf,cu=$(()=>{"use strict";We();xe();vn();Oe();pe();$I=(r,e,n,t)=>{let o=r.session.pack?2:0,i=j(r.session.backend.glContext.version);return{...e,output:{dims:n.dims,type:n.type,textureType:o},shaderSource:`
     ${t.body}
     void main() {
...
vec4 getBAtOutCoordsMatmul(int i) {
  ...
  return outputValue;
}`}function MI(r,e){let n="";for(let t=0;t<e-2;t++)n+=`rc.${r[t]}, `;return n+=`rc.${r[e-2]}, i*2`,n}function VI(r,e){let n="";for(let t=0;t<e-2;t++)n+=`rc.${r[t]}, `;return n+=`i*2, rc.${r[e-1]}`,n}var NI,zI,Ko,fu=$(()=>{"use strict";xe();Oe();pe();cn();nr();jo();NI=(r,e)=>({name:"MatMul (packed)",inputNames:r?["A","B","Bias"]:["A","B"],inputTypes:r?[2,2,2]:[2,2],cacheHint:e}),zI=(r,e,n,t)=>{let o=n.length>2,i=o?"value += getBiasForMatmul();":"",a=n[0].dims,s=n[1].dims,u=Xe.calcShape(a,s,!0),l=!V.areEqual(n[0].dims,n[1].dims);if(!u)throw new Error("Can't use matmul on the given tensors");let c=a[a.length-1],d=Math.ceil(c/2),p=a.length,f=s.length,h=j(r.session.backend.glContext.version),m=Ze(u.length),y=u.length,g=St(),{activationFunction:b,applyActivation:x}=pn(t),w=o?`${pu(m,g,n[2].dims,u,!0)}`:"",v=l?`${BI(m,g,n,u)}`:"",I=l?"getAAtOutCoordsMatmul(i)":`getA(${MI(g,p)})`,P=l?"getBAtOutCoordsMatmul(i)":`getB(${VI(g,f)})`,O=l?"":`${m} rc =
...
`)},v2=r=>{if(!r||r.length!==1)throw new Error("ImageScaler requires 1 input.");if(r[0].dims.length!==4)throw new Error("Invalid input shape.");if(r[0].type!=="float32"&&r[0].type!=="float64")throw new Error("Invalid input type.")}});var Mf,Vf,Bf,I2,S2,$2,A2,P2,O2,Ff=$(()=>{"use strict";Oe();pe();Mf=(r,e,n)=>{O2(e);let t=r.run(S2(e[0]),e);return[r.run(P2(r,e[0],n,t.dims),[e[0],t,e[1],e[2]])]},Vf=r=>r.attributes.getFloat("epsilon",1e-5),Bf={name:"InstanceNormalization_MeanAndVariance",inputNames:["X"],inputTypes:[0]},I2=(r,e)=>{let n=e.dims.slice(),t=n[1],o=n[2]*n[3],i=[n[0],t],a=`
      vec4 process(int[2] indices) {
        ...
        return v;
      }`;return{...r,output:{dims:i,type:e.type,textureType:4},shaderSource:a}},S2=r=>({...Bf,get:()=>I2(Bf,r)}),$2={name:"InstanceNormalization_ComputeOutput",inputNames:["X","MeanAndVariance","Scale","B"],inputTypes:[0,4,0,0]},A2=(r,e,n,t,o)=>{let i=j(r.session.backend.glContext.version),[a,s]=r.calculateTextureWidthAndHeight(o,4),[u,l]=[a/4,s],c=`
...
`)}
    ...
    `;return{...n,output:{dims:o,type:e[0].type,textureType:0},shaderSource:s}},pS=r=>{if(!r||r.length!==2)throw new Error("Tile requires 2 input.");if(r[1].dims.length!==1)throw new Error("The second input shape must 1 dimension.");if(r[1].dims[0]!==r[0].dims.length)throw new Error("Invalid input shape.");if(Nn.indexOf(r[0].type)===-1)throw new Error("Invalid input type.");if(r[1].type!=="int32"&&r[1].type!=="int16")throw new Error("Invalid repeat type.")}});var Au,Yh,em,fS,hS,tm=$(()=>{"use strict";xe();Au=(r,e,n)=>{fS(e);let t=V.unsqueezeShape(e[0].dims,n);return[r.reshapeUnpacked(e[0],t)]},Yh=(r,e)=>(hS(e),Au(r,[e[0]],Array.from(e[1].integerData))),em=r=>r.attributes.getInts("axes"),fS=r=>{if(!r||r.length!==1)throw new Error("Unsqueeze requires 1 input.");if(r[0].type==="string")throw new Error("invalid input tensor types.")},hS=r=>{if(!r||r.length!==2)throw new Error("Unsqueeze requires 2 inputs.");if(r[1].type!=="int32")throw new Error("Invalid input type.")}});var nm,rm=$(()=>{"use strict";pp();Sp();Pp();Lp();qo();yf();If();Af();Ef();Lf();zf();Ff();Hf();jo();Xf();uh();gh();yh();Ih();$h();Ch();Fh();Hh();Kh();Zh();Qh();Xo();cu();tm();Tu();nm=[["Abs","","6+",Rp],["Acos","","7+",Np],["Add","","7+",fp],["And","","7+",hp],["Asin","","7+",zp],["Atan","","7+",Bp],["AveragePool","","7+",Jf,Qf],["BatchNormalization","","7+",cp,dp],["Cast","","6+",$p,Ap],["Ceil","","6+",Fp],["Clip","","6-10",uu,Mp],["Clip","","11+",Vp],["Concat","","4+",Cp,kp],["Conv","","1+",gu,bu],["ConvTranspose","","1+",gf,bf],["Cos","","7+",Gp],["Div","","7+",mp],["Dropout","","7+",lu],["DepthToSpace","","1+",Tf,vf],["Equal","","7+",gp],["Elu","","6+",Up,Wp],["Exp","","6+",Hp],["Flatten","","1+",Sf,$f],["Floor","","6+",qp],["FusedConv","com.microsoft","1+",gu,bu],["Gather","","1+",Pf,Of],["Gemm","","7-10",yu,Df],["Gemm","","11+",yu,kf],["GlobalAveragePool","","1+",eh,th],["GlobalMaxPool","","1+",ah],["Greater","","7+",bp],["Identity","","1+",lu],["ImageScaler","","1+",Rf,Nf],["InstanceNormalization","","6+",Mf,Vf],["LeakyRelu","","6+",jp,Kp],["Less","","7+",yp],["LRN","","1+",Gf,Uf],["Log","","6+",Xp],["MatMul","","1+",lf,cf],["MaxPool","","1+",nh,rh],["Mul","","7+",_p],["Neg","","6+",Zp],["Not","","1+",Jp],["Or","","7+",xp],["Pad","","2-10",_u,qf],["Pad","","11+",jf,Kf],["Pow","","7+",wp],["PRelu","","7+",Tp],["ReduceLogSum","","1+",hh,zn],["ReduceMax","","1+",dh,zn],["ReduceMean","","1+",ch,zn],["ReduceMin","","1+",ph,zn],["ReduceProd","","1+",fh,zn],["ReduceSum","","1-12",lh,zn],["ReduceSumSquare","","1+",mh,zn],["Relu","","6+",Qp],["Reshape","","5+",bh],["Resize","","10",Iu,Th],["Resize","","11+",Iu,vh],["Shape","","1+",Sh],["Sigmoid","","6+",Yp],["Sin","","7+",ef],["Slice","","10+",Eh],["Slice","","1-9",Ah,Ph],["Softmax","","1-12",Rh,Nh],["Softmax","","13+",Bh,zh],["Split","","2-12",Uh,Wh],["Sqrt","","6+",tf],["Squeeze","","1-12",$u,jh],["Squeeze","","13+",qh],["Sub","","7+",vp],["Sum","","6+",Xh],["Tan","","7+",nf],["Tanh","","6+",rf],["Tile","","6+",Jh],["Transpose","","1+",rr,xf],["Upsample","","7-8",xu,xh],["Upsample","","9",xu,wh],["Unsqueeze","","1-12",Au,em],["Unsqueeze","","13+",Yh],["Xor","","7+",Ip]]});function im(r){let e={},n;for(;(n=om.exec(r))!==null;){let t=n[3].split(",").map(o=>{let i=o.trim().split(" ");return i&&i.length===2?{type:i[0],name:i[1]}:null}).filter(o=>o!==null);e[n[2]]={params:t,body:n[4]}}for(let t in e){let o=mS.replace("__FUNC__",t),i=new RegExp(o,"gm");for(;(n=i.exec(r))!==null;){let a=n[1],s=n[2],u=n[3].split(","),l=a?`${a} ${s};`:"",c=e[t].body,d="";e[t].params.forEach((f,h)=>{f&&(d+=`${f.type} ${f.name} = ${u[h]};
`)}),c=`${d}
...
`);let y="";c<2&&l>0?y="coords":y=i.map((O,E)=>`coords.${m[E+f]}`).join(", ");let g="return outputValue;",x=V.size(i)===1,v=V.size(a)===1;if(l===1&&!x&&!v)g=`
    ...
    `;return new z(P,["coordinates.getOutputCoords"])}getUnpackedSamplerAtOutputCoords(e,n,t,o){let i=[t.width,t.height],a=[n.width,n.height],s=n.unpackedShape.length,u=t.unpackedShape.length,l=n.unpackedShape,c=t.unpackedShape,d=Mo(o);if(s===u&&Zn.arraysEqual(a,i)){let x=`
          float ${e}() {
...
`},Ki=(r,e,n,t,o=!1,i)=>{let a=r[0].dims,s=r[1].dims,u=a[a.length-2],l=s[s.length-1],c=a[a.length-1],d=he(l),p=he(c),f=he(u),h=S.size(n)/d/f,m=r.length>2,y=t?t.slice(0,-2):n.slice(0,-2),b=[S.size(y),u,l],x=[{type:12,data:h},{type:12,data:u},{type:12,data:l},{type:12,data:c}];Pt(e,x),x.push(...k(y,a,s)),m&&x.push(...k(r[2].dims)),x.push(...k(b));let w=v=>{let I=Vi("batch_dims",r[0].dataType,y.length),P=A("a",r[0].dataType,a.length,p),O=A("b",r[1].dataType,s.length,d),E=C("output",r[0].dataType,b.length,d),R=ve(E.type.tensor),q=At(e,E.type.value,R),M=[P,O],W="";if(m){let U=o?d:1;M.push(A("bias",r[2].dataType,r[2].dims.length,U)),W=`${o?`value += bias[col / ${U}];`:`value += ${E.type.value}(bias[row + i]);`}`}let ae=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];Ot(e,ae);let F=()=>{let U=`var a_data: ${P.type.value};`;for(let K=0;K<p;K++)U+=`
...
`}return U};return`
  ${v.registerUniforms(ae).registerInternalVariables(I).declareVariables(...M,E)}
  ${v.mainStart()}
...
`},H1=(r,e,n,t,o=!1)=>{let[i,a,s,u]=t,l=ve(t[0].type.tensor);return`
  ...
  ${m?al(y,g,U,F):sl(y,g,U,F)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
    ...
    }`},Xb=(r,e,n,t,o,i,a,s,u)=>{let l=e.format==="NHWC",c=l?r[0].dims[3]:r[0].dims[1],d=n[0],p=l?n[2]:n[3],f=l?n[1]:n[2],h=l?n[3]:n[1],m=l&&(c%4===0||c%3===0)&&h%4===0,y=l?h:p*f,g=l?p*f:h,b=[8,8,1],x=t<=8?[4,1,1]:[4,4,1],w=[Math.ceil(y/b[0]/x[0]),Math.ceil(g/b[1]/x[1]),Math.ceil(d/b[2]/x[2])];ie("verbose",()=>`[conv2d_mm_webgpu] dispatch = ${w}`);let v=m?l&&c%4!==0?3:4:1,I=b[1]*x[1],P=b[0]*x[0],O=Math.max(b[0]*v,b[1]),E=t%I===0,R=o%P===0,q=i%O===0,M=m?[v,4,4]:[1,1,1],W=[{type:6,data:t},{type:6,data:o},{type:6,data:i},{type:6,data:[e.pads[0],e.pads[1]]},{type:6,data:e.strides},{type:6,data:e.dilations}];Pt(e,W),W.push(...k(r[0].dims,r[1].dims));let ae=["rank","rank"];a&&(W.push(...k(r[2].dims)),ae.push("rank")),W.push(...k(n));let F=U=>{let K=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"},{name:"pad",type:"i32",length:2},{name:"stride",type:"i32",length:2},{name:"dilation",type:"i32",length:2}];Ot(e,K);let Q=m?4:1,Y=ve(r[0].dataType),ue=`
      ...
      }`,Ie=A("x",r[0].dataType,r[0].dims.length,v===3?1:v),Be=A("w",r[1].dataType,r[1].dims.length,Q),ee=[Ie,Be],D=C("result",r[0].dataType,n.length,Q);if(a){let X=A("bias",r[2].dataType,r[2].dims.length,Q);ee.push(X),ue+=`
    ...
    for (var i = 0u; i < ${a}u; i++) {
      ...
      ${m.set("batch","row","col + i","output_channel","value")};
        ...
        `,c===1)ee+=`
          ...
          let xValue = ${K.getByOffset("x_offset")};
          let wValue = ${U.getByOffset("w_offset")};
          dotProd = dotProd + dot(xValue, wValue);`}return ee},Be=`
            ...
            for (; wR < uniforms.effective_filter_dims.x; wR = wR + 1) {
              ...
              for (; wC < uniforms.effective_filter_dims.y; wC = wC + 1) {
                ...
                if (dyC < 0.0 || dyC >= ${M}(uniforms.Dy_shape[${ae}]) ||
  ...
  ${v.mainStart()}
    ...
    ${b?"inv_std_output[global_idx] = inv_std_dev":""};
          ...
          `;return Be},ue=()=>{let Be=`
            ...
            let zero_point = ${K}(8);`}
            `;for(let ee=0;ee<h*y;ee++)Be+=`
            let scale${ee} = ${M.getByOffset("col_index * nBlocksPerCol + block")};
            ${ae?`
            ...
            col_index += 1;`;return Be},Ie=()=>{let Be=`col_index = col * ${h};`;for(let ee=0;ee<h*y;ee++)Be+=`
            ...
            var b_dequantized_values: ${Q};`,Be};return`
        ...
        ${q.mainStart([g,y,1])}
          ...
          for (var tile: u32 = 0; tile < num_tiles; tile += 1) {
            ...
            for (var i: u32 = 0; i < ${f}; i++) {
              ...
              let b_quantized_values = mat2x4<${ue}>(${Array.from({length:4},(Be,ee)=>`${ue}(b_value_lower[${ee}]), ${ue}(b_value_upper[${ee}])`).join(", ")});
              let b_dequantized_values = (b_quantized_values - mat2x4<${ue}>(${Array(8).fill("zero_point").join(",")})) * scale;
              inter_results[local_id.y][local_id.x] += ${Array.from({length:2},(Be,ee)=>`${`dot(a_data${ee}, b_dequantized_values[${ee}])`}`).join(" + ")};
              word_offset += ${8/p};
            }
            workgroupBarrier();
          }
